...
async function run() {
  ...
  let ent0 = s1.entity()
  console.log('ent0-did', ent0.private$.get_instance().did)
  ...
  let ent1 = s2.entity()
  console.log('ent1-did', ent1.private$.get_instance().did)
  ...
  let ent2 = s3.entity()
  console.log('ent2-did', ent2.private$.get_instance().did)
